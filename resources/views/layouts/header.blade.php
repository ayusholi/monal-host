<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from www.themelooks.biz/demo/hostpack/html/preview/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 09:11:10 GMT -->
    ...
    <div class="offcanvas_menu">
        ...
        <div class="offcanvas-wrapper style--two fixed-top h-100">
            ...
            <div class="offcanvas-content">
                <div class="widget widget_logo"> <a href="#"><img src="assets/img/sticky-logo.svg" class="svg" alt=""></a></div>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-7">
                        <ul class="info-list justify-content-center justify-content-sm-start">
                            <li> <a href="tel:8884014678"> <img src="assets/img/icon/phone.svg" alt="" class="svg"> 888-401-4678 </a></li>
                            <li> <a href="mailto:info@hostpack.com"> <img src="assets/img/icon/mail.svg" alt="" class="svg"> info@hostpack.com </a></li>
                        </ul>
                    </div>
                    <div class="col-sm-5">
                        <ul class="info-list text-uppercase justify-content-center justify-content-sm-end">
                            <li> <a href="{{ route('auth.login') }}"> <img src="assets/img/icon/login.svg" alt="" class="svg"> Login </a></li>
                            <li> <a href="contact.html"> <img src="assets/img/icon/support.svg" alt="" class="svg"> Support </a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="hp-container">
                <div class="row align-items-center position-relative">
                    <div class="col-12 d-flex align-items-center justify-content-between position-static">
                        <div class="logo">
                            <a href="index.html">
                                <!-- <img src="assets/img/logo.svg" class="main-logo svg" alt=""> <img src="assets/img/sticky-logo.svg" class="sticky-logo svg" alt=""> -->
                        ...
                        <div class="header-right d-sm-flex d-none">
                            ...
                            <div class="search-toggle"> <button class="search-toggle-btn p-0"> <img src="assets/img/icon/search.svg" alt="" class="svg"> </button>
                            ...
                            <div class="offcanvas-trigger ml-3 d-lg-none d-xl-block"> <img src="assets/img/icon/humberger.svg" alt="" class="svg"></div>
                        </div>
                    </div>
                </div>
            </div>
