...
<body>
    ...
    <section class="cta pt-120 pb-120" data-bg-img="{{ asset('assets/img/bg/call_to_action_bg.png') }}"> <img src="{{ asset('assets/img/bg/cta_top.png') }}" alt="" class="cta-top">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="cta-content text-center text-white">
                        ...
                        <form action="https://themelooks.us13.list-manage.com/subscribe/post?u=79f0b132ec25ee223bb41835f&amp;id=f4e0e93d1d" class="newsletter-form">
                            <div class="input-group"> <input class="form-control" type="email" placeholder="Subscribe Newsletter"> <button type="submit" class="btn hover-style-two"> <span>Subscribe Now</span> <img src="{{ asset('assets/img/icon/btn-arrow.svg') }}" alt="" class="svg"> </button></div>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="pricing-table">
                            ...
                            <tfoot>
                                <tr>
                                    <th></th>
                                    <td>
                                        <a href="price.html" class="btn hover-style-two"> <span>Buy Now</span> <img src="{{ asset('assets/img/icon/btn-arrow.svg') }}" alt="" class="svg"> </a>
                                    </td>
                                    <td>
                                        <a href="price.html" class="btn hover-style-two"> <span>Buy Now</span> <img src="{{ asset('assets/img/icon/btn-arrow.svg') }}" alt="" class="svg"> </a>
                                    </td>
    ...
    <script src="{{ asset('assets/js/jquery.min.png') }}"></script>
    <script src="{{ asset('assets/js/bootstrap.bundle.min.png') }}"></script>
    <script src="{{ asset('assets/js/menu.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/owlcarousel/owl.carousel.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/magnific-popup/jquery.magnific-popup.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/retinajs/retina.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/counterup/waypoints.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/counterup/jquery.counterup.min.png') }}"></script>
    <script src="{{ asset('assets/plugins/typed/typed.min.png') }}"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjkssBA3hMeFtClgslO2clWFR6bRraGz0"></script>
    <script src="{{ asset('assets/js/main.png') }}"></script>
    <script src="{{ asset('assets/js/custom.png') }}"></script>
</body>
<!-- Mirrored from www.themelooks.biz/demo/hostpack/html/preview/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 09:15:31 GMT -->
