<footer class="footer" data-bg-img="assets/img/bg/footer3-bg.png">
    <div class="footer-main">
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-sm-6">
                    <div class="widget widget_about text-white"> <a href="index.html" class="footer-logo"> <img src="assets/img/logo.svg" class="svg" alt=""> </a>
                        <div class="menu-container">
                            ...
                            <div class="accept-cards"> <img src="assets/img/media/cards.png" data-rjs="2" alt=""></div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="certificate text-center text-lg-end"> <img src="assets/img/media/certificate3.png" data-rjs="2" alt=""></div>
                </div>
            </div>
        </div>
    </div>
