                                ...
                                <form method="POST" action="{{ route('admin.email-services.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="anti_spam" id="antiSpam" class="form-control">
                                            <option value="1" {{ old('anti_spam') == 1 ? "selected" : null  }}>Yes</option>
                                            <option value="0" {{ old('anti_spam') == 1 ? "selected" : null  }}>No</option>
                                        </select>
                                        @error('anti_spam')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="rate_limit" id="rateLimit" class="form-control">
                                            <option value="1" {{ old('rate_limit') == 1 ? "selected" : null  }}>Yes</option>
                                            <option value="0" {{ old('rate_limit') == 1 ? "selected" : null  }}>No</option>
                                        </select>
                                        @error('rate_limit')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="blacklist_email" id="blacklistEmail" class="form-control">
                                            <option value="1" {{ old('blacklist_email') == 1 ? "selected" : null  }}>Yes</option>
                                            <option value="0" {{ old('blacklist_email') == 0 ? "selected" : null  }}>No</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="feature" id="" cols="30" rows="10" class="feature">{{ old('feature') }}</textarea>
                                        @error('feature')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
