            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" action="{{ route('admin.vps-services.update', ['service' => $service]) }}">
                                    @method('PUT')
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="ram" class="form-control" id="ram" placeholder="Enter RAM" value="{{ $service->vpsService->ram }}">
                                        @error('ram')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ram_unit" class="form-control" id="ramUnit" placeholder="Enter Ram Unit" value="{{ $service->vpsService->ram_unit }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="storage" class="form-control" id="storage" placeholder="Enter Storage" value="{{ $service->vpsService->storage }}">
                                        @error('storage')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="storage_unit" class="form-control" id="storageUnit" placeholder="Enter Storage Unit" value="{{ $service->vpsService->storage_unit }}">
                                        <small class="form-text text-muted">Example: [GB, MB]</small>
                                        @error('storage_unit')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="storage_type" class="form-control" id="storageType" placeholder="Enter Storage Type" value="{{ $service->vpsService->storage_type }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cpu_cores" class="form-control" id="cpuCores" placeholder="Enter CPU Cores" value="{{ $service->vpsService->cpu_cores }}">
                                        @error('cpu_cores')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
