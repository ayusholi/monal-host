            ...
            <div class="table-responsive">
                <table id="recent-orders" class="table table-lg">
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product1.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product2.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product3.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product4.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product5.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product6.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product7.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product8.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product9.png"
                    ...
                    <tr>
                        <td>
                            <a href="product-detail.html" class="d-flex align-items-center">
                                <img width="40" src="https://baston.laborasyon.com/assets/media/image/products/product10.png"
                        ...
                        <div class="card-scroll">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 py-4">
                                    <a href="#" class="flex-shrink-0">
                                        <figure class="avatar mr-3">
                                            <img src="https://baston.laborasyon.com/assets/media/image/user/man_avatar1.jpg"
                                ...
                                <li class="list-group-item d-flex px-0 py-4">
                                    <a href="#" class="flex-shrink-0">
                                        <figure class="avatar mr-3">
                                            <img src="https://baston.laborasyon.com/assets/media/image/user/man_avatar2.jpg"
                                                class="rounded-circle" alt="image">
                                        </figure>
                                    </a>
                                    <div class="flex-grow-1">
                                ...
                                <li class="list-group-item d-flex px-0 py-4">
                                    <a href="#" class="flex-shrink-0">
                                        <figure class="avatar mr-3">
                                            <img src="https://baston.laborasyon.com/assets/media/image/user/man_avatar4.jpg"
                                                class="rounded-circle" alt="image">
                                        </figure>
                                    </a>
                                    <div class="flex-grow-1">
